...
const Hero = () => {
  return (
    <section className="bg-gradient-to-r  from-[#ffffff] to-[#71C8E4] w-full md:h-[23.5rem] lg:h-[33.5rem] xl:h-[41rem]">
      <div className="mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] lg:max-w-[60rem] mx-auto flex flex-col justify-center md:flex-row md:justify-between">
        <div className="lg:pt-[6.3rem] pt-[3rem]">
        ...
        <div>
          <img
            src={care}
            alt=""
            className="mac:w-[47.083rem] w-[20rem] h-[21.5rem] -mt-[1.5rem] md:-mt-[5.5rem] md:w-[23.5rem] md:h-[29rem] lg:w-[35rem] lg:h-[40rem] xl:w-[44.083rem]  xl:h-[49.425rem] lg:-mt-[6.5rem] xl:-mt-[8.5rem]"
          />
        </div>
      </div>
    </section>
