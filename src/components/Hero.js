      ...
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] lg:max-w-[60rem] mx-auto flex flex-col justify-center md:flex-row md:justify-between'>
        ...
        <div>
          <img
            src={care}
            alt=''
            className='mac:w-[47.083rem] hidden md:flex w-[20rem] h-[21.5rem] -mt-[1.5rem] md:-mt-[0rem] md:w-[23.5rem] md:h-[29.5rem] lg:w-[35rem] lg:h-[40rem] xl:w-[44.083rem]  xl:h-[50.525rem] lg:mt-[0.5rem] xl:-mt-[2.5rem]'
          />
        </div>
      </div>
    </section>
