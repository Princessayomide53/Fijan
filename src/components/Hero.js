    ...
    <section className='bg-gradient-to-r  from-[#ffffff] to-[#71C8E4] w-full h-[35rem] md:h-[29.5rem] lg:h-[40.5rem] xl:h-[48rem]'>
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] lg:max-w-[60rem] mx-auto flex flex-col justify-center md:flex-row md:justify-between'>
        <div className='lg:pt-[13.5rem] pt-[7.8rem] md:pt-[8.5rem]'>
          ...
          <p className='text-[#014470] pt-7 md:pt-4 lg:pt-9 lg:w-[32rem] md:text-[12px] lg:text-[14px] xl:text-[1.1rem] mac:text-[1.257rem] font-normal lg:leading-normal xl:leading-[1.75rem]'>
        ...
        <div>
          <img
            src={care}
            alt=''
            className='mac:w-[40.083rem] hidden md:flex w-[20rem] h-[21.5rem] -mt-[1.5rem] md:-mt-[0rem] md:w-[23.5rem] md:h-[29.5rem] lg:w-[35rem] lg:h-[40rem] xl:w-[44.083rem]  xl:h-[50.525rem] lg:mt-[0.5rem] xl:-mt-[2.5rem]'
          />
        </div>
      </div>
    </section>
