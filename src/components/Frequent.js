...
const Frequent = () => {
  ...
  return (
    <section className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[20.3rem] iphone:max-w-[21rem] mx-auto md:h-[21rem] lg:h-[26rem] mac:h-[28rem]'>
