...
const Blogs = () => {
  ...
  return (
    <section className='mac:max-w-[83rem] max-w-[20rem] md:max-w-[45rem] lg:max-w-[60rem] xl:max-w-[75rem] pro:max-w-[52rem] md:pt-[2rem] mx-auto pb-[3.5rem] md:pb-[0rem] xl:pb-[0rem] mac:pb-[5rem]'>
      ...
      <h1 className='text-center md:pb-[2.8rem] pb-[2rem] lg:pb-[3.5rem] text-4xl special-font md:text-4xl md:leading-tight lg:leading-[3.85rem] font-normal lg:text-5xl xl:text-6xl mac:text-7xl text-[#014470] '>
        Our Blog
      </h1>
