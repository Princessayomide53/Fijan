        ...
        {services.map((item, index) => (
          <div className="relative" key={index}>
            ...
            <div className="absolute inset-0 flex flex-col  items-end ">
              <h3 className="text-white uppercase xl:text-[18px] mac:text-[22px] mt-[15rem] md:text-sm lg:text-base font-semibold leading-normal px-7 md:mt-[12rem] lg:mt-[15rem] xl:mt-[20rem]">
                {item.title}
              </h3>
              <button className="bg-white flex gap-2 mt-[2.05rem] mx-[20px] text-[#014470] text-base md:mt-[0.85rem] md:mx-[3.9px] font-normal py-2 xl:mx-[9.5px] lg:mx-[7px] px-[1.2rem] rounded-tl-lg rounded-br-[23px] md:rounded-br-[23px] lg:rounded-br-[29px] xl:rounded-br-[32px] mac:rounded-br-[50px] lg:mt-[1.45rem] xl:mt-[2.5rem] mac:mt-[2rem]">
                {item.text}
