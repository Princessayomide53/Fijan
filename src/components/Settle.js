...
const Settle = () => {
  return (
    <section className='relative mb-[4rem] md:mt-[4rem] lg:mt-[1rem] mac:mt-[3rem] md:mb-[4rem]'>
      ...
      <div className='absolute top-[16rem] md:top-1/2 left-1/2 transform -translate-x-1/2  -translate-y-1/2 text-center text-white'>
        <h3 className='md:text-[2rem] font-normal w-[21rem] text-[35px] leading-[40px] special-font lg:text-[2.5rem] md:w-[28rem] xl:w-[55rem] mac:w-[45rem] 2xl:w-[50rem] mx-auto md:leading-tight xl:text-[3.7rem] xl:leading-[3.75rem] mac:text-[4rem]'>
          Discover the Fijan healthcare difference and witness how we can
          transform your future
        </h3>
        <p className=' font-normal leading-[32px] text-[15px] pt-[42px] md:pt-[1.6rem] md:text-[0.79rem] w-[19rem] md:w-[32rem] lg:w-[48rem] mx-auto lg:text-[0.85rem] xl:text-[0.95rem] mac:text-[1.15rem] md:leading-normal xl:leading-[32px] lg:leading-[2rem] xl:pt-10'>
