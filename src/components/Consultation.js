...
const Consultation = () => {
  ...
  return (
    <section
      id='section1'
      className='bg-[#E8FAFF] w-full md:h-[45rem] lg:h-[50rem] mt-[3rem] mb-[84px] md:mt-0 md:mb-0 md:my-[4rem] xl:my-[5rem]'
    >
            ...
            <form className='mac:space-y-[2.5rem] space-y-[2.2rem] md:space-y-[2.5rem] lg:space-y-[2.7rem] '>
              <div className='flex flex-col gap-3'>
                ...
                <input
                  ...
                  id='name'
                  name='name'
                  className='border-b-2 border-[#098666] pl-5 focus:outline-blue-300 bg-[#E8FAFF] w-full h-[2.5rem] md:h-[3rem]'
                />
              </div>
              <div className='flex  gap-[2.2rem] md:flex-row md:gap-5 xl:justify-between'>
                <div className='flex flex-col gap-3'>
                  ...
                  <input
                    ...
                    id='phoneNumber'
                    name='phoneNumber'
                    className='border-b-2 border-[#098666] focus:outline-blue-400 bg-[#E8FAFF] pl-5 w-full h-[2.5rem] md:h-[3rem]'
                  />
                </div>
                <div className='flex flex-col gap-3'>
                  <label
                  ...
                  <input
                    ...
                    id='email'
                    name='email'
                    className='border-b-2 border-[#098666] focus:outline-blue-300 bg-[#E8FAFF] w-full pl-5 h-[2.5rem] md:h-[3rem]'
                  />
                </div>
              </div>
              <div className='flex flex-col gap-3'>
