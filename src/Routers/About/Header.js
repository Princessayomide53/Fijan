...
const Header = () => {
  return (
    <section className='bg-gradient-to-r from-[#ffffff] to-[#71C8E4] w-full h-[14rem] md:h-[18rem] lg:h-[19.5rem] xl:h-[26rem]'>
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] mx-auto '>
        ...
        <div className='flex items-center justify-center pt-[1.5rem] md:pt-[3rem] lg:pt-[2rem] xl:pt-[3rem]'>
          <img
            src={smile}
            alt=''
