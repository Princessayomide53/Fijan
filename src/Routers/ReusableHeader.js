  ...
  return (
    <section className='bg-gradient-to-r from-[#ffffff] to-[#71C8E4] h-[21rem] w-full md:h-[21rem] lg:h-[22.5rem] xl:h-[27rem]'>
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] mx-auto '>
        ...
        <h2 className='text-center text-[42px] md:text-[5.5rem] lg:text-[6rem] xl:text-[7.5rem] text-[#014470] font-normal leading-normal md:leading-[4rem] lg:leading-[4.7rem] xl:leading-[4rem] special-font'>
          {title}
        </h2>
        <div className='relative flex flex-col items-center justify-center pt-[2.3rem] md:pt-[3rem] lg:pt-[2rem] xl:pt-[3rem]'>
          <img
            src={imageSrc}
            alt=''
