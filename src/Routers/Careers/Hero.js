  ...
  return (
    <section className='bg-gradient-to-r from-[#ffffff] to-[#71C8E4] w-full h-[21.5rem] md:h-[20rem] lg:h-[25.5rem] xl:h-[28rem] mb[5rem] md:mb-[9rem] lg:mb-[9rem] xl:mb-[10rem] mac:mb-[15rem]'>
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] mx-auto '>
        <p className='text-[#098666] pt-[9rem] md:pt-[1.2rem] md:hidden lg:pt-[1rem] text-center  text-[1rem] md:text-[1.5rem] lg:text-[2rem] font-normal leading-[20px]'>
          Nursing and Healthcare Hot jobs
        </p>
        <h2 className='text-center md:pt-[5rem] lg:pt-[7rem] xl:pt-[8.1rem] text-[42px] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7.5rem] text-[#014470] font-normal leading-[42px] md:leading-[4rem] lg:leading-[5.8rem] xl:leading-[6.3rem] special-font'>
          Employers
        </h2>
