...
const Hero = () => {
  return (
    <section className='bg-gradient-to-r from-[#ffffff] to-[#71C8E4] w-full h-[16rem] md:h-[20rem] lg:h-[25.5rem] xl:h-[28rem] mb[5rem] md:mb-[9rem] lg:mb-[9rem] xl:mb-[10rem] mac:mb-[15rem]'>
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] mx-auto '>
        <h2 className='text-center pt-[5rem] md:pt-[5rem] lg:pt-[7rem] xl:pt-[8.1rem] text-[4rem] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7.5rem] text-[#014470] font-normal leading-[4rem] lg:leading-[5.8rem] xl:leading-[6.3rem] special-font'>
          Employers
        </h2>
        ...
        <div className='relative flex flex-col items-center justify-center pt-[1.5rem] md:pt-[3rem] lg:pt-[2rem] xl:pt-[2rem]'>
          <img
            src={Careers}
            alt=''
