  ...
  return (
    <section className='bg-gradient-to-r from-[#ffffff] to-[#71C8E4] h-[20.5rem] w-full md:h-[18rem] lg:h-[19.5rem] xl:h-[26rem]'>
      <div className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] pro:max-w-[52rem] max-w-[22rem] mx-auto '>
        <h2 className='text-center pt-[7rem] md:pt-[5rem] lg:pt-[7rem] xl:pt-[8.1rem] text-[4rem] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7.5rem] text-[#014470] font-normal leading-[4rem] lg:leading-[5.2rem] xl:leading-[6.3rem] special-font'>
          Contact Us
        </h2>
