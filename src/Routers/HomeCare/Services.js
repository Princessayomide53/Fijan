    ...
    <section className='mac:max-w-[83rem] md:max-w-[45rem] xl:max-w-[75rem] lg:max-w-[60rem] pro:max-w-[52rem] max-w-[22rem] mx-auto '>
      <div className='md:mt-[16rem] mt-[7rem] lg:mt-[22rem] mac:mt-[26rem] flex flex-col gap-5 md:gap-0 md:flex-row md:justify-between'>
        <span>
          ...
          <p className='pt-[2.5rem] md:text-[13px] md:w-[19.5rem]  lg:w-[28rem] xl:w-[38rem] flex flex-wrap text-[#26465B] lg:text-base xl:text-lg font-normal leading-normal'>
            We give you the flexibility of staying in a familiar environment
            where you’re relaxed and receptive to our care services.
            <br />
            <br />
            We work closely with you to understand your healthcare needs and
            deliver to your advantage.
            <br />
            <br />
            You can be around your loved onces while our professional caregivers
            ensure that you recieve nothing short of quality care.
            <br />
            <br />
            We will care you at home, giving you standardize and quality care.{' '}
          </p>
        </span>
        <article className='relative mt-16 md:mt-24 lg:mt-20'>
          <img
            src={Frame}
            alt=''
            className='lg:mr-[6rem] h-[240px] ml-[0.7rem] mt-5 md:h-[280px] lg:h-full object-contain md:mr-[6rem] md:-mt-2 lg:-mt-7 xl:-mt-0 mac:-mt-5 xl:mr-[10rem]'
          />
          <div className='bg-[#E1F8FF] w-[290px] h-[370px] md:h-[390px] lg:h-[425px] xl:h-[460px] rounded-lg px-[44px] py-[2.5rem] absolute z-10 -top-10 left-10 md:-top-16 md:right-1 lg:right-5 md:w-[320px] lg:w-[370px] xl:w-[414px]'>
